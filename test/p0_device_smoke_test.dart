...
void main() {
  ...
  group('P0 Device & Compatibility Smoke Suite', () {
    testWidgets(
      'App root initializes cleanly under ProviderScope without startup crash',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          const ProviderScope(
            child: MaterialApp(
              home: Scaffold(body: Center(child: Text('Yunoo App Ready'))),
            ),
          ),
        );
    ...
    testWidgets(
      'IrregularVerbs tutorial page renders built-in educational mode UI',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          ProviderScope(
            overrides: [
    ...
    test(
      'IncomingDestinationParser parses valid push notification payload deterministically',
      () {
    ...
    test(
      'UserStats initializes default non-null metrics for new user profile',
      () {
