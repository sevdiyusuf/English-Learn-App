  ...
  group('Irregular Verbs Educational Content Reporting Widget Tests', () {
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(
          find.text('Incorrect answer or wrong information'),
          findsOneWidget,
        );
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        // Success snackbar
        expect(
          find.text('Thank you! Your report has been submitted.'),
          findsOneWidget,
        );
      },
    );
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.tap(find.text('Audio / pronunciation issue'));
        await tester.pumpAndSettle();
        ...
        expect(
          find.text('You have already reported this issue recently.'),
          findsOneWidget,
        );
      },
    );
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(find.text('Sign in to report content issues.'), findsOneWidget);
      },
    );
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(
          find.text('Could not submit your report. Please try again later.'),
          findsOneWidget,
        );
      },
    );
    ...
    testWidgets('failed reporting does not block tutorial / TTS / navigation', (
      ...
      // Ensure page elements and audio TTS are still functional
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(find.text('Yazım hatası'), findsOneWidget);
        expect(find.text('Yanlış cevap veya bilgi'), findsOneWidget);
        expect(find.text('Ses / telaffuz sorunu'), findsOneWidget);
