...
describe('Sprint 11A — Multiplayer Concurrency & Idempotency Tests', () => {
    ...
    test('Player leave during active room does not crash or corrupt room state', async () => {
        ...
        const wrappedLeave = testEnv.wrap(leaveArenaRoom);
