...
_$UserStatsImpl _$$UserStatsImplFromJson(Map<String, dynamic> json) =>
    _$UserStatsImpl(
      ...
      lastActivityDate:
          const TimestampConverter().fromJson(json['lastActivityDate']),
      modeStats: (json['modeStats'] as Map<String, dynamic>?)?.map(
            (k, e) =>
                MapEntry(k, ModeStats.fromJson(e as Map<String, dynamic>)),
          ) ??
          const <String, ModeStats>{},
      last30Days: (json['last30Days'] as List<dynamic>?)
              ?.map(
                  (e) => DailyActivityPoint.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const <DailyActivityPoint>[],
      hardestWords: (json['hardestWords'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const <String>[],
    );
...
Map<String, dynamic> _$$UserStatsImplToJson(_$UserStatsImpl instance) =>
    <String, dynamic>{
      ...
      'lastActivityDate':
          const TimestampConverter().toJson(instance.lastActivityDate),
