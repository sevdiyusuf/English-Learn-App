...
import 'synonym_word.dart';

class FlashSynonymState {
  const FlashSynonymState({
    this.currentWord,
    this.options = const [],
    this.selectedOption,
    this.score = 0,
  ...
  FlashSynonymState copyWith({
    SynonymWord? currentWord,
    List<String>? options,
