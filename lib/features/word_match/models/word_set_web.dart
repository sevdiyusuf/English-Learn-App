...
const dynamic WordSetSchema = null;

class _DummyCollectionWeb {
  Future<int> count() async => 0;
}

extension GetWordSetCollectionWeb on dynamic {
  dynamic get wordSets => _DummyCollectionWeb();
  dynamic isBuiltinEqualTo(bool value) => null;
  dynamic ownerUidEqualTo(String? value) => null;
  dynamic cloudIdEqualTo(String? value) => null;
  dynamic sourceSetIdEqualTo(String? value) => null;
  dynamic pendingMigrationUidEqualTo(String? value) => null;
  dynamic sortByUpdatedAtDesc() => null;
  dynamic idEqualTo(int value) => null;
  dynamic idNotEqualTo(int value) => null;
