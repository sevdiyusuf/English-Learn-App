...
class EngineTransform extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selections = currentAnswer ?? List<String>.filled(item.steps.length, '');
    ...
    return Column(
      ...
      children: [
          ...
          child: Column(
            ...
            children: [
              ...
              if (isLocked) ...[
                ...
                Text(
                  item.answer is String ? item.answer : item.raw['final_answer'] ?? '',
        ...
        ...List.generate(item.steps.length, (index) {
          ...
          final stepSelection = index < selections.length ? selections[index] : '';
                  ...
                  children: [
                    ...
                    if (isLocked) ...[
                      ...
                      Icon(
                        ...
                        color: isStepCorrect ? AppColors.success : AppColors.error,
                        size: 20,
                      ),
                    ]
                  ],
