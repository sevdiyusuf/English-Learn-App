...
_$RoomImpl _$$RoomImplFromJson(Map<String, dynamic> json) => _$RoomImpl(
  ...
  playerNames:
      ...
      const <String, String>{},
  activePlayerIds:
      (json['activePlayerIds'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const <String>[],
  currentTurnIndex: (json['currentTurnIndex'] as num?)?.toInt() ?? 0,
  currentTurnUid: json['currentTurnUid'] as String?,
  turnDeadlineAt: const TimestampConverter().fromJson(json['turnDeadlineAt']),
  ...
  settings: const GameRoomSettingsConverter().fromJson(
...
Map<String, dynamic> _$$RoomImplToJson(
  _$RoomImpl instance,
) => <String, dynamic>{
  ...
  'turnDeadlineAt': const TimestampConverter().toJson(instance.turnDeadlineAt),
